...
async function askQuestion() {
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      message:
        "Q2.What type of assignment is this variable, `const fullName: string = 'Dylan Israel';`?",
    },
    {
      type: "list",
      name: "question3",
      ...
      message:
        "Q3.Which is a successful example of this tuple `[number, string]`?",
    },
    {
      type: "list",
      name: "question4",
      ...
      message:
        "Q4.What is the inherited type for the variable example in `const example = ['Dylan']`?",
    },
    {
      type: "list",
      name: "question5",
      choices: ["True", "False"],
      message:
        "Q5.True or False: a Tuple and an Array are the same thing when discussing types?",
    },
]);
let score:number = 0;
