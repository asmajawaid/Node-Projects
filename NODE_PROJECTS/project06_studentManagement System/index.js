...
class Student {
    ...
    Id;
    name;
    courses; // Specify the type for courses array
    balance;
    constructor(name) {
        this.Id = Student.counter++;
        this.name = name;
...
class student_manager {
    ...
    view_studentBalance(student_Id) {
        let students0 = this.find_student(student_Id);
        if (students0) {
    ...
    while (true) {
        ...
        switch (choice.choice) {
            ...
            case "Enroll student":
                ...
                student_managerFunction.Enroll_student(course_input.student_Id, course_input.Course);
                break;
            ...
            case "pay fees":
                ...
                student_managerFunction.pay_studentFees(fees_input.student_Id, fees_input.amount);
                break;
            case "show status":
